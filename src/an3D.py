...
#dpdx = Constant(-1.8e-6) #Re=2.2 pw 9.0379*0.966=8730 1.8e-6*0.966=1.7388e-6
#pw 12263*0.7119 --> 0.7119*1.8e-6 = 1.28142e-6
#dpdx = Constant(-1.28142e-4)
#dpdx = Constant(-0.0000021)# 154.545454*1.28142e-6
#dpdx = Constant(-0.00010525)# Re110 = 0.000002105*50 = 0.000105 
dpdx = Constant(-0.00014883306)# Re170 = 0.000002105*77.2727272727 = 0.000105 
# new Re=170: pv(0.00016265909)= 7.3820e-1... 7.382e-1*0.915=6.75453e-1 
# -->0.00016265909*0.915 = 0.00014883306


#dpdx = Constant(-8.37e-11) # Re=110 = 50*Re2_2
#dpdx = Constant(-1.685e-4) #Re170, gives 0.954 in pw , 0.954*0.7071536= 674624 -->
#7071536*1.685e-4 = 0.0001191553816 = 1.191553816e-4
#dpdx = Constant(-1.191553816e-4)#Re170,
...
def pre_solve_hook(mesh, OasisFunction, u_, ds, Q, **NS_namespace):
    ...
    #fu = File("2e5/2e5.pvd")
    #fu = File("/media/mo/TOSHIBA EXT/master/3D/1e5an3DRe2dt10ts100fine_dpdx1_28/1e5an3DRe2dt10ts100fine_dpdx1_28.pvd")
    
    return dict(Vv=Vv, uv=OasisFunction(u_, Vv), bcs_vv=bcs_vv, p0bc=p0bc, p1bc=p1bc, ds=ds)

def start_timestep_hook(t, **NS_namespace):  
	pass

def temporal_hook(tstep, q_, u_, uv, Vv, plot_interval, bcs_vv, **NS_namespace):#gu,
	...
	if tstep % plot_interval == 0:
		...
		fu = File("5e5Re170T1e6/U5e5Re170T1e6.pvd")
		gu = File("5e5Re170T1e6/P5e5Re170T1e6.pvd")
		fu << uv
		gu << q_['p']
